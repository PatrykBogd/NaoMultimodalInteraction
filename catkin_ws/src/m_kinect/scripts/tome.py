...
#Get all nessecery Vectors
    ...
    def set_nao_face_detection_tracking(self,enabled):
	self.faceProxy.enableTracking(enabled)

    def nao_go(self,x,y):
	self.postureProxy.goToPosture("Standing",1.0)
	self.set_nao_face_detection_tracking(False)
	...
	self.set_nao_face_detection_tracking(True)
