...
if __name__ == '__main__':
	...
	thread.start_new_thread((lambda:tr.goto_process()),())
	thread.start_new_thread((lambda:tr.tome_process()),())
	thread.start_new_thread((lambda:tr.hello_process()),())
	thread.start_new_thread((lambda:tr.sensei_process()),())
	thread.start_new_thread((lambda:tr.leftHand_process()),())
	thread.start_new_thread((lambda:tr.rightHand_process()),())
